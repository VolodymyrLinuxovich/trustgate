...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://hhfuaqkhrjmojecgbixp.supabase.co");
const supabaseKey = ("TURBOPACK compile-time value", "sb_publishable_eI5aDZM7GCNJNeyiSI3ULA_G8YwhRfA");
...
;
async function GET() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("audit_logs").select("*").order("created_at", {
        ascending: false
    });
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b5514262._.js.map