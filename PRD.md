...
- The backend must deploy cleanly to Vercel as a serverless Fastify app
...
- [x] Add `medianLatencyMs` to ranking items
- [x] Add `rateLimitedCount` to ranking items
...
- [x] Add latency measurement to `scripts/review-api.ts`
- [x] Add success and failure classification to `scripts/review-api.ts`
...
- [x] Add the open write API contract to `INSTALL.md`
...
- [x] Add frontend API client helpers for `GET /rankings`
